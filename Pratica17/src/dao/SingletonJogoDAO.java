...
public class SingletonJogoDAO {
    ...
    public List<Jogo> getAllJogosByPlataforma(String plataforma) {
        List<Jogo> jogos = new ArrayList<>();
        try {
            Statement comandoSql = conn.createStatement();
    ...
    public List<Jogo> getAllJogosByGenero(String genero) {
        List<Jogo> jogos = new ArrayList<>();
        try {
            Statement comandoSql = conn.createStatement();
    ...
    public void updateJogo(Jogo jogo) {
        try {
            Statement comandoSql = conn.createStatement();
            comandoSql.executeUpdate("UPDATE Jogos SET nome=\"" + jogo.nome + "\"," + "genero=\"" + jogo.genero + "\"," + "plataforma=\"" + jogo.plataforma + "\"," + "lancamento=\"" + jogo.lancamento + "\" WHERE id=" + jogo.id + ";");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
